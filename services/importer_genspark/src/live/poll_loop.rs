//! D16 COV_87 — bounded exponential-backoff poll loop. Mirrors D14's
//! design: max backoff cap ≤ 1 hour to prevent unbounded growth that
//! could DoS the Genspark admin API.
...
pub struct PollConfig {
    ...
    /// Upper bound for the backoff. ≤ 1 hour.
...
mod tests {
    ...
    #[test]
    fn backoff_cap_is_at_most_one_hour() {
        let cfg = PollConfig::default();
