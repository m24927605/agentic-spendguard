...
export class SpendGuardApi implements ICredentialType {
  ...
  displayName = "SpendGuard API";
  documentationUrl =
    "https://agenticspendguard.dev/docs/integrations/n8n/";
  properties: INodeProperties[] = [
    ...
    },
    {
      ...
      description:
        "Unix domain socket path the runner pod uses to reach the SpendGuard sidecar; required for v0.1.x.",
    },
    {
    ...
    },
    {
      ...
      default: "n8n",
      description:
        "Telemetry attribution; forwarded to SpendGuard. Override only if you need to disambiguate multi-tenant n8n installs.",
    },
  ];
}
