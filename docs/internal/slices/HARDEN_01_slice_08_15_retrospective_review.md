...
- Review SLICE_08 merge `6adb6f0` against `docs/internal/slices/SLICE_08_cold_start_baseline_table.md`
- Review SLICE_09 merge `6407648` against `docs/internal/slices/SLICE_09_run_cost_projector.md`
- Review SLICE_10 merge `c649196` against `docs/internal/slices/SLICE_10_egress_proxy_decision_rewrite.md`
- Review SLICE_11 merge `ab8f4b1` against `docs/internal/slices/SLICE_11_multi_provider_routing.md`
- Review SLICE_12 merge `019c62f` against `docs/internal/slices/SLICE_12_sdk_default_estimators.md`
- Review SLICE_13 merge `83466fa` against `docs/internal/slices/SLICE_13_calibration_report_cli.md`
- Review SLICE_14 merge `10af232` against `docs/internal/slices/SLICE_14_customer_template_contrib.md`
- Review SLICE_15 merge `8908f9e` against `docs/internal/slices/SLICE_15_end_to_end_benchmark.md`
- For each slice, run `git diff <merge_base>..<merge_commit>` and record review notes under `docs/internal/reviews/hardening/HARDEN_01/`
...
- `docs/internal/reviews/hardening/HARDEN_01/SLICE_08.md`
- `docs/internal/reviews/hardening/HARDEN_01/SLICE_09.md`
- `docs/internal/reviews/hardening/HARDEN_01/SLICE_10.md`
- `docs/internal/reviews/hardening/HARDEN_01/SLICE_11.md`
- `docs/internal/reviews/hardening/HARDEN_01/SLICE_12.md`
- `docs/internal/reviews/hardening/HARDEN_01/SLICE_13.md`
- `docs/internal/reviews/hardening/HARDEN_01/SLICE_14.md`
- `docs/internal/reviews/hardening/HARDEN_01/SLICE_15.md`
...
- Eight review files exist under `docs/internal/reviews/hardening/HARDEN_01/`
...
- [ ] Codex review passes or Staff+ arbitration is recorded
