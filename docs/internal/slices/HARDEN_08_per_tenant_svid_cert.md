...
- `docs/internal/reviews/hardening/HARDEN_08/svid-cert-validation.md`
...
- `docs/internal/slices/SLICE_07_output_predictor_plugin_c.md` adoption/history note if needed
...
- [x] Codex review passes or Staff+ arbitration is recorded (R1-R5 fixed; Staff+ arbitration recorded)
