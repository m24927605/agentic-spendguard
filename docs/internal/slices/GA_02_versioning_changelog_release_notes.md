...
- Add evidence under `docs/internal/reviews/ga-readiness/GA_02_versioning_changelog_release_notes/`
...
- `scripts/release/prepare-release-notes.sh --check docs/internal/reviews/ga-readiness/GA_02_versioning_changelog_release_notes/sample-release-notes.md`
