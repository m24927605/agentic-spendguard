...
- Add evidence under `docs/internal/reviews/post-ga/POST_GA_09_strategy_c_resilience/`
...
- Evidence under `docs/internal/reviews/post-ga/POST_GA_09_strategy_c_resilience/`
...
| Reviewer R1 | Found endpoint-cache singleflight did not share true-miss or DB-error stale results; found force-reset audit effect overclaimed predictor breaker reset semantics | Direct codex CLI review |
...
| Reviewer R2 | Found true-miss backoff table was unbounded and expired one-off tenants were not swept unless looked up again | Direct codex CLI review |
| Implementer R2 | Capped true-miss backoff table at 4096 tenants and sweep expired entries on insert | `8b5dc46` |
| Reviewer R3 | No findings after rechecking R1/R2 fixes, tests, docs, and diff hygiene | Direct codex CLI review |
