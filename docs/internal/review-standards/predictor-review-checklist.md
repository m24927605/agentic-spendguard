...
implementer records the finding list
...
Each slice's own doc (`docs/internal/slices/SLICE_XX_*.md`) has a `§9` section with concrete adversarial questions specific to that slice. Reviewer must run §1 + slice's §9.
