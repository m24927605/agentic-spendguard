...
Slice: `docs/internal/slices/POST_GA_01_ledger_replay_semantics.md`
...
```sh
ait run --adapter codex --review-mode adversarial --base main --branch post-ga/POST_GA_01_ledger_replay_semantics --slice-doc docs/internal/slices/POST_GA_01_ledger_replay_semantics.md --review-budget deep
```
