...
```sh
rg -o 'spendguard\.[A-Za-z0-9_.:-]+' docs/stats-aggregator-spec-v1alpha1.md docs/contract-dsl-spec-v1alpha2.md docs/calibration-report-spec-v1alpha1.md docs/internal/slices/SLICE_13_calibration_report_cli.md | sort -u
```
...
docs/internal/slices/SLICE_13_calibration_report_cli.md:spendguard.audit.calibration.report_generated.v1alpha1
