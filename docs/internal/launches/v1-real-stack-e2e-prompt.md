...
3. cat docs/internal/marketing/SPENDGUARD_VIRAL_PLAYBOOK.todo.md | head -30
...
- 在 `docs/internal/marketing/SPENDGUARD_VIRAL_PLAYBOOK.todo.md` 開新 Tier 0 條目 V1，狀態 ✅ + commit hash
