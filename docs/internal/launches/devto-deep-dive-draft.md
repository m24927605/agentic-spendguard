...
> **Status**: draft, not yet published. Per `docs/internal/marketing/seo-plan.md` §1 Lever 4 + `memory/project_overview.md`, this goes out **1–2 weeks after the HN post**, not before. The HN post is the trigger; this is the long-tail follow-up.
>
