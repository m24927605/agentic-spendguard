...
Per `docs/internal/marketing/seo-plan.md` §1 Lever 4 sequencing: dev.to / Medium technical deep-dive follow-up goes out 1–2 weeks after the HN post, NOT before.
