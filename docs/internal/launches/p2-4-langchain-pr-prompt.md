...
> from `docs/internal/marketing/SPENDGUARD_VIRAL_PLAYBOOK.todo.md`.
...
關鍵檔案（讀這些建立 context）
=============================
- `docs/internal/marketing/SPENDGUARD_VIRAL_PLAYBOOK.md` — 戰略 plan
- `docs/internal/marketing/SPENDGUARD_VIRAL_PLAYBOOK.review.md` — codex 對抗審查
- `docs/internal/marketing/SPENDGUARD_VIRAL_PLAYBOOK.todo.md` — 開放工作追蹤（這個任務是 P2-4）
...
3. cat docs/internal/marketing/SPENDGUARD_VIRAL_PLAYBOOK.todo.md | grep -A 5 "P2-4"
4. 報告當前狀態確認
...
**2.3 在我方 repo 同步加追蹤**
- 把這次 PR URL 寫到 `docs/internal/launches/upstream-prs.md`（新檔）追蹤
- 更新 todo P2-4 狀態為 🔄
...
- 採納 must-fix，修改草稿
- 把 codex review 存 `docs/internal/launches/p2-4-langchain-pr.review.md`
...
- `docs/internal/launches/upstream-prs.md` 加上 PR URL + status
- 更新 P2-4 狀態 🔄 → ⏳（等審查）
...
- [ ] HN draft（`docs/internal/launches/hn-show-hn-draft.md`）的 precondition 3 留 PR 連結（仍需等 merged 才打勾）
...
- After PR opens, expect 1–4 weeks for maintainer review. Track in `docs/internal/launches/upstream-prs.md`.
