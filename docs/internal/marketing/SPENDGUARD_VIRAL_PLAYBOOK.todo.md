...
- **P0 prompt ready**：`docs/internal/launches/cost-advisor-p0-prompt.md` — 4 步驟（schema audit / proto+trait / migrations / integration design）
...
- **Detail**：[`docs/internal/launches/v1-phase1-bug-report.md`](../launches/v1-phase1-bug-report.md)
...
- **Prompt**：`docs/internal/launches/v1-real-stack-e2e-prompt.md`
...
- **產出**:
  - `docs/internal/launches/cold-email-template.md` — 公開模板（≤180 字 cold-email + channel guidance）
  - `docs/internal/launches/outreach-list.template.md` — schema 模板進 git
  - `.gitignore`: `docs/internal/launches/outreach-list.md` 阻擋實際 list 進 git
...
當 M1 + P1-1 + P1-2 + P1-3 都完成 → 觸發 HN launch 條件評估（見 `docs/internal/launches/hn-show-hn-draft.md` 第 3 個 precondition）
