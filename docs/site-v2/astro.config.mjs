      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Vercel AI SDK (covers Mastra)', slug: 'docs/integrations/vercel-ai' },
            ...
            { label: 'Anthropic claude-agent-sdk (egress proxy recipe)', slug: 'docs/integrations/claude-agent-sdk' },
            ...
            { label: 'SmolAgents (Python)', slug: 'docs/integrations/smolagents' },
            { label: 'Letta / MemGPT (Python — library mode)', slug: 'docs/integrations/letta' },
            { label: 'LlamaIndex (Python)', slug: 'docs/integrations/llamaindex' },
            { label: 'Atomic Agents + Instructor (Python)', slug: 'docs/integrations/atomic-agents' },
            ...
            { label: 'Botpress Integration SDK (TypeScript)', slug: 'docs/integrations/botpress' },
