---
title: "The Agent Spend Governance Gap"
description: "Why token counters aren't enough. Observability standards describe what happened; FinOps describes what was charged; identity layers describe who. None of them reject the call before it spends. Five properties of a real solution."
---
...
- An [OpenTelemetry GenAI extension proposal](https://github.com/m24927605/agentic-spendguard/blob/main/docs/proposals/otel-genai-spend-extension.md) puts the spend-decision events on the same GenAI span as the provider call itself. Existing OTel dashboards keep working; spend governance becomes just another span event.
