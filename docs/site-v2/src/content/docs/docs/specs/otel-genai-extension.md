---
title: "OpenTelemetry GenAI extension: spend-governance span events"
description: "Proposed OTel GenAI semconv extension adding gen_ai.spend.reserve / .commit / .release / .audit span events so pre-call budget decisions surface on the same GenAI span as the provider call."
---
