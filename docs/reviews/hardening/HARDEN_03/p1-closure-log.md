...
| #171 | none in HARDEN_03 | Left open by design. Ownership is HARDEN_08 per `docs/slices/HARDEN_08_per_tenant_svid_cert.md`; HARDEN_03 posts a tracking comment only. |
