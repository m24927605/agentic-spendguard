...
//! ## Asset integrity
//!
//! [`with_embedded_assets`] verifies that the sha256 of each
//! embedded asset matches the const in
//! [`crate::asset_sha256`]. Mismatch → fail-fast at boot per
//! §7.4. There is NO env-var override (per §9 review question 3).
